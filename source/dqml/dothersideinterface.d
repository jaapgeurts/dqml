...
extern (C)
{
    ...
    void* dos_qqmlextensionplugin_create(void*,// TODO: add meta object support
            //    void*,
            //                                           void function (void*, void*, int, void**),
            const ref DosQQmlExtensionPluginCallbacks callbacks);
    void dos_qqmlextensionplugin_delete(void*);
    ...
    void* dos_qobject_create(void*, void*, void function(void*, void*, int, void**));
    void dos_qobject_signal_emit(void*, immutable(char)* name,
            int parametersCount, void** parameters);
    bool dos_qobject_connect_lambda_static(void*, immutable(char)*, void*,
            immutable(char)*, int);
    bool dos_qobject_disconnect_static(void*, immutable(char)*, void*, immutable(char)*);
    ...
    void* dos_qabstractitemmodel_create(void*, void*, void function(void*,
            void*, int, void**), const ref DosQAbstractItemModelCallbacks callbacks);
    ...
    void dos_qabstractitemmodel_dataChanged(void* vptr, void* topLeft,
            void* bottomRight, int* rolesPtr, int rolesLength);
    ...
    void* dos_qabstractlistmodel_create(void*, void*, void function(void*,
            void*, int, void**), const ref DosQAbstractItemModelCallbacks callbacks);
    ...
    void* dos_qabstracttablemodel_create(void*, void*, void function(void*,
            void*, int, void**), const ref DosQAbstractItemModelCallbacks callbacks);
    ...
    void* dos_qmetaobject_create(void* superclass, immutable(char)* className,
